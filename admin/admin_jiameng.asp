...
Private Sub Deljiameng()
	...
	if IsSqlDataBase = 1 then
		enchiasp.Execute(" delete from [ECCMS_jiameng] where ID = " & Request("ID"))
	else
		enchiasp.Execute(" delete * from [ECCMS_jiameng] where ID = " & Request("ID"))
	end if
	'enchiasp.Execute(" delete [ECCMS_jiameng] where ID = " & Request("ID"))
	OutHintScript("删除成功！")
End Sub
...
<th class=tablerow1>获知媒体</th>
<th class=tablerow1>拟投金额</th>
<th class=tablerow1>资金来源</th>
<th class=tablerow1>店面情况</th>
<th class=tablerow1>实用面积</th>
<th class=tablerow1>简历</th>
<th class=tablerow1>区域调查</th>
<th class=tablerow1>其它</th>
...
<%
	...
	FoundSQL = "  "
	TotalNumber = enchiasp.Execute("Select Count(ID) from ECCMS_jiameng "& FoundSQL &"")(0)
	TotalPageNum = CInt(TotalNumber / maxperpage)  '得到总页数
	If TotalPageNum < TotalNumber / maxperpage Then TotalPageNum = TotalPageNum + 1
	If CurrentPage < 1 Then CurrentPage = 1
	If CurrentPage > TotalPageNum Then CurrentPage = TotalPageNum
	Set Rs = Server.CreateObject("ADODB.Recordset")
	SQL = "select * from [ECCMS_jiameng] "& FoundSQL &" order by id desc "
...
Response.Write "	<td " & strClass & ">"
		Response.Write Rs("shenqingquyu")
		Response.Write "	</td>"
...
Response.Write "	<td " & strClass & ">"
		Response.Write Rs("meiti")
		Response.Write "	</td>"

Response.Write "	<td " & strClass & ">"
		Response.Write Rs("jine")
		Response.Write "	</td>"

Response.Write "	<td " & strClass & ">"
		Response.Write Rs("laiyuan")
		Response.Write "	</td>"

Response.Write "	<td " & strClass & ">"
		Response.Write Rs("dianmian")
		Response.Write "	</td>"

Response.Write "	<td " & strClass & ">"
		Response.Write Rs("mianji")
		Response.Write "	</td>"
...
Response.Write "	<td " & strClass & "><a href='?action=del&id="& rs("id") &"'>"
		Response.Write "删除"
		Response.Write "	</a></td>"
