...
%>
	...
	<tr>
		...
		<p><B>注意</B>：<BR>①、删除分类同时将删除该分类下所有的文章信息！删除分类同时删除下属分类和所有文章！ 操作时请完整填写表单信息。<BR>
		 ...
		 ③、添加或者删除分类后，请重新<a href="?action=jsmenu&ChannelID=<%=ChannelID%>&stype=1" class=showmenu>生成分类JS导航菜单</a></p>
		</td>
	</tr>
	<tr>
		<td class="TableRow2">
		...
		| <a href="?action=jsmenu&ChannelID=<%=ChannelID%>&stype=1"><font color=red>生成分类菜单JS</font></a>
		</td>
	</tr>
</table>
<br>
...
If Not ChkAdmin("AdminClass" & ChannelID) Then
