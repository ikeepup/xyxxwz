...
document.writeln("<DIV CLASS=\"Btn\" title=\"字体背景颜色\" onClick=BackColor()><img class='Ico' src=" +strPath+ "bgcolor.gif></DIV>");
...
document.writeln("<div class='TBSep'></div><DIV CLASS=\"Btn\" title=\"插入表情图标\" onclick=em()><img class='Ico' src=" +strPath+ "emot.gif></DIV>"); ///HTML代码
