...
<table border=0 cellpadding=0 cellspacing=0 width='100%' class='Toolbar' id='enchicms_Toolbar'>
<tr>
...
<DIV CLASS="TBSep"></DIV><DIV CLASS="Btn" TITLE="查找替换" onclick="findReplace()"><IMG CLASS="Ico" SRC="images/findreplace.gif"></DIV>
...
<DIV CLASS="Btn" TITLE="恢复" onclick="goHistory(1)"><IMG CLASS="Ico" SRC="images/redo.gif"></DIV>
<DIV CLASS="TBSep"></DIV>
...
<DIV CLASS="TBSep"></DIV><DIV CLASS="Btn" TITLE="插入或修改超级链接" onclick="createLink()"><IMG CLASS="Ico" SRC="images/CreateLink.gif"></DIV>
...
<DIV CLASS="Btn" TITLE="字体颜色" onclick="ShowDialog('dialog/selcolor.htm?action=forecolor', 280, 250, true)"><IMG CLASS="Ico" SRC="images/forecolor.gif"></DIV></div></td>
</tr>
<tr>
<td><div class=yToolbar><DIV CLASS="TBHandle"></DIV><SELECT CLASS="TBGen" onchange="format('FormatBlock',this[this.selectedIndex].value);this.selectedIndex=0"><option selected>段落样式</option>
...
<DIV CLASS="Btn" TITLE="两端对齐" onclick="format('JustifyFull')"><IMG CLASS="Ico" SRC="images/JustifyFull.gif"></DIV>
<DIV CLASS="TBSep"></DIV>
...
<form id="enchicms_UploadForm" action="upload.asp?action=remote&type=remote" method="post" target="enchicms_UploadTarget">
