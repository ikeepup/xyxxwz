...
<DIV CLASS="BtnMenu" TITLE="更多字体" onclick="showToolMenu('font')"><IMG CLASS="Ico" SRC="images/arrow.gif"></DIV>
<DIV CLASS="TBSep"></DIV>
...
<DIV CLASS="BtnMenu" TITLE="更新段落菜单" onclick="showToolMenu('paragraph')"><IMG CLASS="Ico" SRC="images/arrow.gif"></DIV>
<DIV CLASS="TBSep"></DIV>
<DIV CLASS="Btn" TITLE="全屏编辑" onclick="Maximize()"><IMG CLASS="Ico" SRC="images/maximize.gif"></DIV>
<DIV CLASS="Btn" TITLE="查看使用帮助" onclick="ShowDialog('dialog/help.htm','400','300')"><IMG CLASS="Ico" SRC="images/help.gif"></DIV></div></td>
</tr>
<tr>
...
<DIV CLASS="BtnMenu" TITLE="更多对象效果菜单" onclick="showToolMenu('object')"><IMG CLASS="Ico" SRC="images/arrow.gif"></DIV>
<DIV CLASS="TBSep"></DIV>
...
<DIV CLASS="BtnMenu" TITLE="更多组件菜单" onclick="showToolMenu('component')"><IMG CLASS="Ico" SRC="images/arrow.gif"></DIV>

<DIV CLASS="TBSep"></DIV>
<DIV CLASS="Btn" TITLE="工具菜单" onclick="showToolMenu('tool')"><IMG CLASS="Ico" SRC="images/toolmenu.gif"></DIV>
